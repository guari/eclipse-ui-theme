...
| The text of the buttons and other widgets have a color difficult to read (GTK) | It's due to the state of GTK3 porting on SWT. Start Eclipse with this flag: ```export SWT_GTK3=0``` |
